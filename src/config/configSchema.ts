    ...
    .object({
      ...
      git: z
        .object({
          ...
          patchDetailLevel: z.enum(['full', 'stat', 'files', 'metadata']).optional(),
...
export const repomixConfigDefaultSchema = z.object({
  ...
  output: z.object({
    ...
    git: z.object({
      ...
      // Git history analysis options with sensible defaults
      includeHistory: z.boolean().default(false),
      historyRange: z.string().default('HEAD~50..HEAD'),
      patchDetailLevel: z.enum(['full', 'stat', 'files', 'metadata']).default('stat'),
